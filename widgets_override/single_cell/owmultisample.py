...
class OWMultiSample(owloaddata.OWLoadData):
    ...
    def __init__(self):
        ...
        # 부모 클래스 OWLoadData 는 유형 A (resizing_enabled=False, Qt.Dialog 자동)
        # 인데, 본 서브클래스가 resizing_enabled=True 로 덮어써 Qt.Window 가 되어
        # Openbox 자동 최대화 대상이 됨. 명시적으로 Qt.Dialog 타입 강제.
        self.setWindowFlags(

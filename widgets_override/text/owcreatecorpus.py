...
class DocumentEditor(QGroupBox):
    ...
    def __init__(self, title, text, parent=None):
        ...
        self.title_le.setPlaceholderText(_t("Document title"))
        ...
        self.text_area.setPlaceholderText(_t("Document text"))
...
class OWCreateCorpus(OWWidget):
    ...
    def __init__(self):
        ...
        add_btn = gui.button(
            self.buttonsArea, self, _t("Add document"), self._add_new_editor
        )
    ...
    def commit(self):
        ...
        doc_var = StringVariable(_t("Document"))
        title_var = StringVariable(_t("Title"))

...
class InfoBox(object):
    ...
    def draw(self):
        ...
        # 2026-05-28: 초기 "No data sent to output yet, please click 'Send' when
        # ready." 경고 표시 제거 — 모든 Textable 위젯이 빈 상태에서 노란 경고
        # 삼각형으로 노출되어 사용자 혼란 유발. 데이터 입력/송신 시점에 자동으로
        # 갱신되는 dataSent/customMessage 흐름은 그대로 유지.
        # self.initialMessage()

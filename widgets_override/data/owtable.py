...
from AnyQt.QtCore import (
    Qt, QSize, QTimer, QMetaObject, QItemSelectionModel, QModelIndex, QRect
)
...
class OWTable(OWWidget):
    ...
    # 옛 클래스명(OWDataTable)으로 저장된 워크플로우 호환을 위한 매핑.
    # Orange3 가 클래스를 OWTable 로 리네임했지만 .ows 파일에는 옛 이름이 남아있음.

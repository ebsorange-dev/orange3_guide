from orangecanvas.localization import Translator as _OrangeTr
_tr = _OrangeTr('Orange', 'biolab.si', 'Orange')
del _OrangeTr
"""
Feature Constructor
...
from AnyQt.QtCore import Qt, QSize, pyqtSignal as Signal, pyqtProperty as Property

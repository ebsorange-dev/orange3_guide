...
class LineChartEditor(QWidget):
    ...
    def __init__(self, model: PyListModel):
        ...
        hlayout.addWidget(QLabel(_t("Type:")))
        ...
        self.__log_check_box = QCheckBox(_t("Logarithmic axis"))
...
class OWLineChart(OWWidget):
    ...
    def setup_gui(self):
        ...
        self._add_button = gui.button(self.controlArea, self, _t("Add plot"),
    ...
    def __extract_data(
        ...
        var_pred = variable.name + _t(" (forecast)")

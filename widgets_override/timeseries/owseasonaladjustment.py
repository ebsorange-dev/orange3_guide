...
class OWSeasonalAdjustment(widget.OWWidget):
    ...
    # 사용자 안내 알림 비노출 (additive/multiplicative model + season period)
    UserAdviceMessages = []
    ...
    class Error(widget.OWWidget.Error):
        ...
        not_enough_instances = Msg(_t("Time series has to have at least 3 instances."))
